...
public:
    ...
    bool addSoldier(const char* name, const Date& birthDate,
                    const char* role, Soldier::eRank rank);
    bool addOfficer(const char* name, const Date& birthDate,
                    const char* role, Soldier::eRank rank);
    ...
    bool addEquipment(const char* warehouseName, const char* equipmentName,
    ...
    bool addTrainingMission(const char* missionName, int unitId,
    ...
    bool addMissionEquipment(int missionId, const char* warehouseName,
